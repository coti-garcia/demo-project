<template>
  <div class="row section-space--pt_60">
    <div class="col-10 objetivos-top">
      ...
      <p>
        UCDD Chile quiere ser un aliado estratégico del sector
...
export default {
  ...
  data() {
    return {
      items: [
        {
          icon: require("../assets/img/student_illustration.png"),
          text:
            "Crear una <strong >plataforma para el desarrollo de investigación colaborativa</strong> entre investigadores de Chile y Candem, capaz de generar innovaciones que impacten la competitividad del sector agroalimentario chileno.",
        },
        {
          icon: require("../assets/img/water_tower_illustration.png"),
          text:
            "Provocar procesos efectivos de <strong>transferencia tecnológica desde UCDD hacia la industria chilena</strong>, ya sea a partir de desarrollos actualmente disponibles en Candem y los Estados Unidos, como de los resultados de la I+D que se genere con los socios chilenos.",
        },
        {
