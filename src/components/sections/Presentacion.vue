<template>
  <div class="feature-app-showcase section-space--pt_120" id="presentacion">
    <div class="container">
      ...
      <SectionTitle
        color="arboretum"
        sectionTitle="El sentido de este reporte"
        class="wow move-up"
      />
      <div class="row">
        <div class="col-12 col-md-3">
          <p class="intro blue">
            Como
            <em>Centro de Innovación UCDD Chile</em> presentamos una
        ...
        <div class="col-12 col-md-4">
          <p>
            ...
            entre Chile y el estado de Candem, relación que se materializa
            ...
            UCDD (UCDD) es uno de los líderes a nivel mundial.
          </p>
          <p>
            ...
            gran relevancia, tanto para Chile como para Candem.
          </p>
        </div>
        <div class="col-12 col-md-4">
          <p>
            Nuestro propósito, vigente desde la inauguración de UCDD Chile
            el 2015, ha sido
            <em class="arboretum"
            ...
            compartir la experiencia de Candem con Chile ha sido inspirador
