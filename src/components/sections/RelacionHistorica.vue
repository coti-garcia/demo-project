      ...
      <div class="container">
        <div class="row">
          <div class="col">
            ...
            <SectionTitle
              color="pinot"
              sectionTitle="Relación histórica <br />entre Chile y UCDD"
              class="wow move-up"
            />
            <p class="text-center intro pinot mx-auto mb-5">
              La decisión de instalar en Chile el
              <em>Centro de Innovación UCDD Chile</em>, se enmarca dentro de
              una historia de más de 50 años de colaboración e intercambio
              académico entre Chile y Candem.
            </p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-12 col-md-6">
            <p>
              En este marco, la asociación entre UCDD y Chile permanece
            ...
            <p>
              ...
              <em>Centro de Innovación UCDD Chile</em>
              y la experiencia de UCDD, la investigación agrícola ha movido
        ...
        <div class="text-center mt-md-5 pt-5">
          ...
          >
            Ver Hitos de la relación entre Chile y UCDD desde los años 60
          </router-link>
        </div>
        <!-- product overview -->
      </div>
