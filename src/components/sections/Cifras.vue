  ...
  <div>
      ...
      <div class="container">
        <div class="row">
          <div class="col">
            ...
            <SectionTitle
              color="icing"
              sectionTitle="Cifras de nuestra gestión"
              class="wow move-up"
            />
          </div>
        </div>
    ...
    <div class="section-space--ptb_120 bg-image">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h3 class="subtitle mb-5 blue text-uppercase">
              Mirando hacia la sustentabilidad <br />
              <strong>financiera del centro </strong>
            </h3>
          </div>
        </div>
        <div class="row">
          <div class="col-12 col-md-10 blue big-text">
            <p>
              ...
              científica de nuestra Universidad en Candem (el 2019, de los
              USD 845,5 millones obtenidos por UCDD para I+D, más del 81%
              proviene del gobierno federal y del Estado de Candem).
            </p>
            <p>
              ...
              Tecnológicos. En este caso el modelo apunta a un financiamiento de
              tres tercios: uno basal aportado por el Estado, otro de fondos
              públicos competitivos y el último de contratos específicos con la
              industria
            </p>
            <p>
              UCDD Chile procura avanzar hacia este modelo, utilizando como
              base el conocimiento y la experiencia de la Universidad de
              Candem que se ha generado por la inversión del estado de
              Candem y fondos federales de los Estados Unidos, así como el
