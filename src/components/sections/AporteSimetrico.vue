    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-12">
          <SectionTitle
            color="strawberry"
            sectionTitle="Aporte simétrico para <br/>Chile y Candem"
            class="wow move-up"
          />
        </div>
        <div class="row">
          <div class="col-12 col-lg-3">
            <p class="intro blue">
              El trabajo del
              <em>Centro de Innovación UCDD Chile</em> se realiza en
              conjunto con UCDD y el resto de los campus integrantes del UC
              System en Candem. Con ello generamos un flujo e intercambio de
              investigaciones y conocimientos relevantes para Chile y
              Candem.
            </p>
          </div>
          <div class="col-12 col-lg-8 mt-4 mt-mb-0">
            <p>
              ...
              negocios y obtención de recursos con Candem.
            </p>
            <p>
              A su vez, para UCDD han surgido nuevas oportunidades para sus
              investigadores y estudiantes, posibilidades de transferencia
              tecnológica, y la instalación de una plataforma que actúa como un
              hub internacional para Latinoamérica.
            </p>
